<div class="nav-bar">
    <nav>
        <ul>
            ...
            <li class="nav-list"><i class="fa-brands fa-figma"></i> <a class="nav-link" href="../coordinator%20pages/coordinatorDesign.php">System Design </a></li>
            <li class="nav-list"><i class="fa-solid fa-code"></i> <a class="nav-link" href="../coordinator%20pages/coordinatorImplementation.php">Implementation </a></li>
        </ul>
    </nav>
</div>
